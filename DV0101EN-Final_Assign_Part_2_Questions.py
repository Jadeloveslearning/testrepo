...
app.layout = html.Div([
    ...
    html.Div(id='..........', className='..........', style={'textAlign':'center', 'color':'#503D36', 'font-size':'24'}),])
])
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [
            html.Div(className='..........', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={'display':'flex'}),
